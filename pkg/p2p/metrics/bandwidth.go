...
var (
	totalIn             = NewCounter("total_send", "Total bytes sent", nil)
	totalOut            = NewCounter("total_recv", "Total bytes received", nil)
	messagesPerProtocol = NewCounter(
		"messages_per_protocol",
		"Number of messages sent per protocol",
		[]string{"protocol", "direction"},
	)
	trafficPerProtocol = NewCounter(
